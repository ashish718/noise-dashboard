...
function AppHome() {
  ...
  let HomeData = async () => {
    ...
    let fetchdata = await axios
      .get(`${process.env.REACT_APP_BASE_URL}/mobile/category`, {
        headers: req_headers,
      })
      .then((data) => {
  ...
  return (
    <div className="conatiner my-2" style={{ width: "100%" }}>
      <h1 className="my-2 mb-4" style={{textAlign:'center', fontFamily:"Arial Rounded MT Bold"}}>App Home</h1>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => updateSlider(e, "img", key)}
                />
                <input
                  className="mb-2"
                  type="text"
                  placeholder="Enter New Handle"
                  onChange={(e) => updateSlider(e, "handle", key)}
                />
                <input
                  type="text"
                  placeholder="Enter New Url"
                  onChange={(e) => updateSlider(e, "url", key)}
                />
              </td>
            </tr>
          ))}
      ...
      <button type="submit" onClick={(e) => updateHome(e)}>
        Update
      </button>
    </div>
  );
